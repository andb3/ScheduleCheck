...
public class AspenStudentController {
  ...
  public CompletableFuture<ResponseEntity<JSONReturn>> serveSchedule(@PathVariable(value="district-id") String districtName,
    ...
    if (u != null && p != null) {
      return CompletableFuture.completedFuture(new ResponseEntity<>(new JSONReturn(getStudent(districtName, u, p), new ErrorInfo()), HttpStatus.OK));
    } else {
